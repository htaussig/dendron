(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("notes.harrytaussig.com/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "notes.harrytaussig.com/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'notes.harrytaussig.com/assets/css/just-the-docs-' + theme + ".css"
      );
    };
